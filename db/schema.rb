...
ActiveRecord::Schema.define(version: 20161125113225) do
  ...
  create_table "spree_contact_requests", force: :cascade do |t|
    t.integer  "user_id"
  ...
  add_index "spree_contact_requests", ["user_id"], name: "index_spree_contact_requests_on_user_id", using: :btree
  ...
  create_table "spree_follow_services", force: :cascade do |t|
  ...
  add_index "spree_follow_services", ["product_id"], name: "index_spree_follow_services_on_product_id", using: :btree
  add_index "spree_follow_services", ["user_id"], name: "index_spree_follow_services_on_user_id", using: :btree
  ...
  create_table "spree_notification_requests", force: :cascade do |t|
  ...
  add_index "spree_notification_requests", ["country_id"], name: "index_spree_notification_requests_on_country_id", using: :btree
  add_index "spree_notification_requests", ["user_id"], name: "index_spree_notification_requests_on_user_id", using: :btree
  ...
  create_table "spree_product_time_ranges", force: :cascade do |t|
    t.integer  "product_id",    null: false
    t.integer  "week_day"
  ...
  add_index "spree_product_time_ranges", ["product_id"], name: "index_spree_product_time_ranges_on_product_id", using: :btree
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.time     "duration",             default: '2000-01-01 00:00:00', null: false
  end
  ...
  create_table "spree_role_users", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.date     "until_date"
    t.boolean  "want_to_become_pro", default: false, null: false
    t.datetime "deleted_at"
  end

  add_index "spree_role_users", ["deleted_at"], name: "index_spree_role_users_on_deleted_at", using: :btree
  ...
  create_table "spree_service_provider_ratings", force: :cascade do |t|
    t.integer  "service_provider_id",             null: false
  ...
  add_index "spree_service_provider_ratings", ["service_provider_id"], name: "index_spree_service_provider_ratings_on_service_provider_id", using: :btree
  ...
  create_table "spree_subscribe_requests", force: :cascade do |t|
    ...
    t.datetime "updated_at",                        null: false
    t.string   "api_key"
    t.string   "api_merchant_code"
    t.string   "api_passphrase"
  end

  add_index "spree_subscribe_requests", ["address_id"], name: "index_spree_subscribe_requests_on_address_id", using: :btree
  add_index "spree_subscribe_requests", ["delivery_address_id"], name: "index_spree_subscribe_requests_on_delivery_address_id", using: :btree
  add_index "spree_subscribe_requests", ["role_user_id"], name: "index_spree_subscribe_requests_on_role_user_id", using: :btree
  add_index "spree_subscribe_requests", ["service_provider_id"], name: "index_spree_subscribe_requests_on_service_provider_id", using: :btree
  ...
  create_table "spree_user_feedbacks", force: :cascade do |t|
  ...
  add_index "spree_user_feedbacks", ["service_provider_id"], name: "index_spree_user_feedbacks_on_service_provider_id", using: :btree
  add_index "spree_user_feedbacks", ["user_id", "service_provider_id"], name: "index_user_feedbacks_on_user_id_and_service_provider_id", unique: true, using: :btree
  add_index "spree_user_feedbacks", ["user_id"], name: "index_spree_user_feedbacks_on_user_id", using: :btree
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.string   "api_merchant_code"
    t.string   "api_passphrase"
    t.integer  "wanted_to_become",                                           default: 0,                  null: false
  ...
  add_index "spree_users", ["country_id"], name: "index_spree_users_on_country_id", using: :btree
  ...
  create_table "spree_variant_locations", force: :cascade do |t|
    t.integer  "variant_id",               null: false
    t.integer  "country_id"
    t.float    "latitude",   default: 0.0, null: false
    t.float    "longitude",  default: 0.0, null: false
    t.float    "radius_km",  default: 0.0, null: false
  ...
  add_index "spree_variant_locations", ["country_id"], name: "index_spree_variant_locations_on_country_id", using: :btree
  add_index "spree_variant_locations", ["latitude", "longitude"], name: "index_spree_variant_locations_on_latitude_and_longitude", using: :btree
  add_index "spree_variant_locations", ["variant_id"], name: "index_spree_variant_locations_on_variant_id", using: :btree
  ...
  add_foreign_key "spree_user_feedbacks", "spree_users", column: "user_id"
end
